...
pub fn SelectProject() -> Element {
    ...
    rsx! {
        div { class: "h-full overflow-hidden flex flex-col bg-content-background text-foreground",
            ...
            div { class: "bg-foreground/30 {crate::util::OVERLAY_TITLEBAR_OFFSET} fixed inset-0 z-50 flex items-center justify-center animate-in fade-in duration-100 backdrop-blur-[2px]",
